...
%       Power & Energy Systems, Volume 30, Issues 6鈥?, July鈥揝eptember 2008,
%       Pages 361-367
...
mpc.branch = [  %% (r and x specified in ohms here, converted to p.u. below)
    ...
    %鏂板鑱旂粶绾?    11	43	2.0000	2.0000	0	0	0	0	0	0	0	-360	360;
	13	21	2.0000	2.0000	0	0	0	0	0	0	0	-360	360;
	15	46	2.0000	2.0000	0	0	0	0	0	0	0	-360	360;
	28	65	0.5000	0.5000	0	0	0	0	0	0	0	-360	360;
	50	59	0.5000	0.5000	0	0	0	0	0	0	0	-360	360;
];
